...
public class SpongeConfig implements ExtraChunkyConfig {
    ...
    public SpongeConfig(ExtraChunkySponge plugin) {
        this.configPath = plugin.getConfigPath().resolve("extrachunky.json");
        reload();
    }
